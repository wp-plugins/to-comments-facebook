...
= 1.0.5 =
*  Adicionado tradução em Espanhol e Alemão.

= 1.0.4 =
*   A largura do comentário agora é responsiva (100%) e não mais ajustável por configuração.

= 1.0.3 =
*   Agora é possível configurar para exibir o sistema de  Comentários do Facebook junto com o Sistema de Comentários Nativo do WordPress. É possível configurar a ordem em qual eles serão exibidos como também é possível permitir que somente o Sistema de Comentário do Facebook seja exibido (como já era antes).

= 1.0.2 =
*   Agora é possível configurar qual link deseja relacionar com os comentários. (shotlink ou permalink)
